          ...
          try{
            ...
            try {
              ...
              if(Utils.quoteJsonToContentVals(getResponse) == null){
                  Intent messageIntent = new Intent(MyStocksActivity.MESSAGE_EVENT);
                  messageIntent.putExtra(MyStocksActivity.MESSAGE_KEY,mContext.getResources().getString(R.string.not_found));
